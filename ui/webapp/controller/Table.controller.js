sap.ui.define([
	...
	return Controller.extend("com.bosch.sbs.sbsfioritemplate.TableSelectDialog.C", {
		...
		handleTableSelectDialogPress: function (oEvent) {
			...
			if (!this._pDialog) {
				this._pDialog = Fragment.load({
					id: oView.getId(),
					name: "com.bosch.sbs.sbsfioritemplate.TableSelectDialog.Dialog",
					controller: this
		...
		handleValueHelp: function () {
			...
			if (!this._pValueHelpDialog) {
				this._pValueHelpDialog = Fragment.load({
					id: oView.getId(),
					name: "com.bosch.sbs.sbsfioritemplate.TableSelectDialog.ValueHelp",
					controller: this
